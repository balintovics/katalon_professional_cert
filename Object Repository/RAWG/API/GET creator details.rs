...
<WebServiceRequestEntity>
   ...
   <name>GET creator details</name>
   <tag></tag>
   <elementGuidId>d4636fbe-e7ad-4da7-a068-66c3c94dbf77</elementGuidId>
   ...
   <restUrl>${GlobalVariable.baseUrl}${GlobalVariable.creatorsPath}/${creatorId}?key=${GlobalVariable.key}</restUrl>
