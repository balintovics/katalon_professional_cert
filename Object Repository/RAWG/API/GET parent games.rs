...
<WebServiceRequestEntity>
   ...
   <name>GET parent games</name>
   <tag></tag>
   <elementGuidId>ed35c5c0-de04-401e-a441-bc443967b50e</elementGuidId>
   ...
   <restUrl>${GlobalVariable.rawgUrl}${GlobalVariable.gamesPath}/${gameId}${GlobalVariable.parentGamesPath}?key=${GlobalVariable.key}</restUrl>
