...
<WebServiceRequestEntity>
   ...
   <name>GET game addition details</name>
   <tag></tag>
   <elementGuidId>19521639-6499-4d73-8423-89fcb5b43860</elementGuidId>
   ...
   <restUrl>${GlobalVariable.rawgUrl}${GlobalVariable.gamesPath}/${gameId}/additions?key=${GlobalVariable.key}</restUrl>
