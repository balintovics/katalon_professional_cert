...
<WebServiceRequestEntity>
   ...
   <name>GET trailers</name>
   <tag></tag>
   <elementGuidId>3cc3f696-e5fe-4ef9-a8a5-281621479f1e</elementGuidId>
   ...
   <restUrl>${GlobalVariable.rawgUrl}${GlobalVariable.gamesPath}/${gameId}${GlobalVariable.trailersPath}?key=${GlobalVariable.key}</restUrl>
