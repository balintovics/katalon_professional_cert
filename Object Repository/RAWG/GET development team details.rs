...
<WebServiceRequestEntity>
   ...
   <name>GET development team details</name>
   <tag></tag>
   <elementGuidId>a677f049-915d-44b5-85f3-d0c37d56ca15</elementGuidId>
   ...
   <restUrl>${GlobalVariable.rawgUrl}${GlobalVariable.gamesPath}/${gameId}${GlobalVariable.developmentTeamPath}?key=${GlobalVariable.key}</restUrl>
