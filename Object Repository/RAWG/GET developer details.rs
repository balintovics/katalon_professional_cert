...
<WebServiceRequestEntity>
   ...
   <name>GET developer details</name>
   <tag></tag>
   <elementGuidId>e5524436-2d1c-43ac-92e7-d19caeec351a</elementGuidId>
   ...
   <restUrl>${GlobalVariable.baseUrl}${GlobalVariable.developersPath}/${developerId}?key=${GlobalVariable.key}</restUrl>
