...
<WebServiceRequestEntity>
   ...
   <name>GET platform details</name>
   <tag></tag>
   <elementGuidId>6c6cc704-dc5d-42e3-b7af-47eb685a7873</elementGuidId>
   ...
   <restUrl>${GlobalVariable.baseUrl}${GlobalVariable.genresPath}/${genreId}?key=${GlobalVariable.key}</restUrl>
