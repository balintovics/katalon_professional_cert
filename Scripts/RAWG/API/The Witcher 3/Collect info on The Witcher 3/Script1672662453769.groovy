...
WS.sendRequest(findTestObject('RAWG/API/GET game details', [('gameId') : GlobalVariable.witcherId]))

WS.comment('Collect data on possible achievements.')

WS.sendRequest(findTestObject('RAWG/API/GET achievement details', [('gameId') : GlobalVariable.witcherId]))

WS.comment('Find out if the game has any additions.')

WS.sendRequest(findTestObject('RAWG/API/GET game addition details', [('gameId') : GlobalVariable.witcherId]))

WS.comment('Get screenshots from the game.')

WS.sendRequest(findTestObject('RAWG/API/GET screenshot', [('gameId') : GlobalVariable.witcherId]))

WS.comment('Obtain the subreddit url of The Witcher 3.')

WS.sendRequest(findTestObject('RAWG/API/GET subreddit', [('gameId') : GlobalVariable.witcherId]))

WS.comment('Get trailers of the game.')

WS.sendRequest(findTestObject('RAWG/API/GET trailers', [('gameId') : GlobalVariable.witcherId]))